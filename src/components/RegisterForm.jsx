...
function LogIn(props) {
    ...
    return ( 
        ...
        <div className={checker === active ? "log-in-display-none" : "log-in"}>
            <header>
                <nav className='register-header'>
                    <h3>бүртгүүлэх</h3>
                </nav>
            </header>
            ...
            <div className='log-button-section'>
