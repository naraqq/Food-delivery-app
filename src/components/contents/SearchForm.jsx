...
function SearchForm(props) {
  ...
  const filteredData = data.filter(e => e.name.includes(props.searchVal) || e.category.includes(props.searchVal))
  useEffect(() => {
  ...
  return (
    <div className='SearchForm'>
      <div className='search-form-head'>
        ...
        <img className='search-form-img' src={"mobile-version-icons/see more.svg"} alt="" />
