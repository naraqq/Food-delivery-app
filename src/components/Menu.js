    ...
    return (
        <div className="menu-container">
            <div className="menu-filter-btn-container" variant="pills">
                <button className="menu-filter-btn menu-filter-btn-active" onClick={filterHandler} value={'Үндсэн хоол'}>Үндсэн хоол</button>
                <button className="menu-filter-btn" onClick={filterHandler} value={'Салад ба зууш'}>Салад ба зууш</button>
                <button className="menu-filter-btn" onClick={filterHandler} value={'Амттан'}>Амттан</button>
                <button className="menu-filter-btn" onClick={filterHandler} value={'Хямдралтай'}>Хямдралтай</button>
            </div>
