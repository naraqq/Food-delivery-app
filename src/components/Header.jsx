    ...
    return (
        ...
        <div>
            ...
            {headerSearch ?
                ...
                < div style={{ backgroundColor: "rgba(0, 0, 0, 0.4)" }} className='switchNavbar'>
                    <div className='switchBarContainer'>
                        <form onSubmit={handleSubmit} onBlur={searchBarAppear} className='min-input' action="">
                            <button>
                                <svg className='input_search_icon_min' width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.9062 11.4922L9.07031 8.65625C9 8.60938 8.92969 8.5625 8.85938 8.5625H8.55469C9.28125 7.71875 9.75 6.59375 9.75 5.375C9.75 2.70312 7.54688 0.5 4.875 0.5C2.17969 0.5 0 2.70312 0 5.375C0 8.07031 2.17969 10.25 4.875 10.25C6.09375 10.25 7.19531 9.80469 8.0625 9.07812V9.38281C8.0625 9.45312 8.08594 9.52344 8.13281 9.59375L10.9688 12.4297C11.0859 12.5469 11.2734 12.5469 11.3672 12.4297L11.9062 11.8906C12.0234 11.7969 12.0234 11.6094 11.9062 11.4922ZM4.875 9.125C2.78906 9.125 1.125 7.46094 1.125 5.375C1.125 3.3125 2.78906 1.625 4.875 1.625C6.9375 1.625 8.625 3.3125 8.625 5.375C8.625 7.46094 6.9375 9.125 4.875 9.125Z" fill="#F17228" />
                                </svg>
                            </button>
                            <input onChange={e => setUserValue(e.target.value)} onSubmit={searchBarAppear} placeholder='Хайх' type="text" />
                        </form>
                    </div>
                </div>
                    ...
                    <div className="navContainer">
                        <div className='toggler'>
                            <button onClick={toggler} type="button">
                                <svg id={Toggling ? "close_icon" : null} className={!Toggling ? "ham-burger" : "ham-rotate"} width="16" height="16" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M15.4531 2.60938C15.6641 2.60938 15.875 2.43359 15.875 2.1875V1.0625C15.875 0.851562 15.6641 0.640625 15.4531 0.640625H0.546875C0.300781 0.640625 0.125 0.851562 0.125 1.0625V2.1875C0.125 2.43359 0.300781 2.60938 0.546875 2.60938H15.4531ZM15.4531 8.23438C15.6641 8.23438 15.875 8.05859 15.875 7.8125V6.6875C15.875 6.47656 15.6641 6.26562 15.4531 6.26562H0.546875C0.300781 6.26562 0.125 6.47656 0.125 6.6875V7.8125C0.125 8.05859 0.300781 8.23438 0.546875 8.23438H15.4531ZM15.4531 13.8594C15.6641 13.8594 15.875 13.6836 15.875 13.4375V12.3125C15.875 12.1016 15.6641 11.8906 15.4531 11.8906H0.546875C0.300781 11.8906 0.125 12.1016 0.125 12.3125V13.4375C0.125 13.6836 0.300781 13.8594 0.546875 13.8594H15.4531Z" fill="#F17228" />
                                </svg>
                                <svg id={!Toggling ? "close_icon" : null} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#F17228" viewBox="0 0 16 16">
                        ...
                        <form onSubmit={handleSubmitWeb} className='max-input' action="">
                            <button >
                                <svg className='input_search_icon' width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M11.9062 11.4922L9.07031 8.65625C9 8.60938 8.92969 8.5625 8.85938 8.5625H8.55469C9.28125 7.71875 9.75 6.59375 9.75 5.375C9.75 2.70312 7.54688 0.5 4.875 0.5C2.17969 0.5 0 2.70312 0 5.375C0 8.07031 2.17969 10.25 4.875 10.25C6.09375 10.25 7.19531 9.80469 8.0625 9.07812V9.38281C8.0625 9.45312 8.08594 9.52344 8.13281 9.59375L10.9688 12.4297C11.0859 12.5469 11.2734 12.5469 11.3672 12.4297L11.9062 11.8906C12.0234 11.7969 12.0234 11.6094 11.9062 11.4922ZM4.875 9.125C2.78906 9.125 1.125 7.46094 1.125 5.375C1.125 3.3125 2.78906 1.625 4.875 1.625C6.9375 1.625 8.625 3.3125 8.625 5.375C8.625 7.46094 6.9375 9.125 4.875 9.125Z" fill="#F17228" />
                                </svg>
